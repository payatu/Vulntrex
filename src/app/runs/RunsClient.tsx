...
export default function RunsClient({ runs }: { runs: RunListItem[] }) {
  ...
  return (
    <div className="space-y-6">
      {/* Filters */}
      <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md rounded-2xl shadow-sm border border-gray-200 dark:border-slate-800 p-6 sticky top-20 z-30">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">Filter & Search</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Refine your scan results</p>
          </div>
